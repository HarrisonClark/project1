...
db.execute("CREATE TABLE books (id SERIAL PRIMARY KEY, isbn VARCHAR NOT NULL, title VARCHAR NOT NULL, author VARCHAR NOT NULL, year INTEGER NOT NULL, avg_rating NUMERIC DEFAULT 0, review_count NUMERIC DEFAULT 0);")
db.commit()
